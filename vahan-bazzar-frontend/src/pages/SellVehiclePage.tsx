  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const submitData = {
        ...
        fuel_tank_capacity: formData.fuel_tank_capacity,
        safety_features: formData.safety_features,
        comfort_features: formData.comfort_features,
        technology_features: formData.technology_features
      };
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <div className="mb-12">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-2">
                Upload multiple images of your vehicle (JPG, PNG, etc.)
              </p>
            </div>
          </div>
          ...
          <div className="text-center mb-4">
            <button
              ...
              onClick={() => {
                ...
                alert(`Form state: Brand=${formData.brand}, Model=${formData.model}, Category=${formData.category}, Fuel=${formData.fuel_type}, Price=${formData.price}`);
              }}
          ...
          <div className="text-center">
            <button
              type="submit"
              disabled={loading}
              className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-12 py-4 rounded-xl font-semibold text-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
            >
